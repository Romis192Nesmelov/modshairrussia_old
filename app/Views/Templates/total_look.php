            ...
            <div class="sanity_slider__content">
                <?php $looks = [
                    [
                        ...
                        'title' => 'Образ Росси',
                        'list' => [
                            ['title' => 'Окрашивание mod’s hair в технике Glossing', 'text' => 'благодаря чередованию оттенков, локоны выглядят рельефно'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'text' => 'Каре с локонами. Чёлка достаточно короткая, чтобы сфокусировать внимание на выражении глаз.'],
                    ...
                    [
                        ...
                        'title' => 'Образ Индия',
                        'list' => [
                            ['title' => 'Окрашивание mod’s hair в технике L`Intensurfer mod`s hair', 'text' => 'Красоту балаяжа в золотисто-бежевых оттенках подчёркивают волны'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'text' => 'Красивая градуированная стрижка на длинные волосы'],
                    ...
                    [
                        ...
                        'title' => 'Образ Милин',
                        'list' => [
                            ['title' => 'Окрашивание mod’s hair в технике Surfer Contouring', 'text' => 'Контуринг с прядями тёплых оттенков выгодно оттеняет овал лица'],
                            ['title' => 'Стрижка по технике coiffe decoiffe', 'text' => 'Эта стрижка на длинные волосы с ярко выраженной градуировкой добавляет волосам динамики и делает образ мягким.'],
