        ...
        <div>
            <div class="section__heading section__heading_center">
                <h4 class="text_xl section__heading__title">
                    <?= !empty($service) && array_key_exists('other_services', $service) && !empty($service['other_services']) ? $service['other_services']['title'] : '<span class="color_primary">Услуги</span> салона красоты ' . PROJECT_HTML . ':'; ?>
                </h4>
            </div>
