<div style="display: none!important;" class="sanity_popup popup_subscribe promo-popup" sanity-popup="promo-offer">
  <div class="popup_subscribe__inner">
    ...
    <form class="form popup_subscribe__form">
      ...
      <p class="big popup_subscribe__form__title"><b>И получи СКИДКУ 20% на первый визит до 15 декабря!</b></p>
      <div class="row">
...
<div style="display: none!important;" class="promo-footer d-none">
  <div class="promo-footer__container">
    ...
    <div class="promo-footer__title promo-footer__title--big">И получи скидку 20% на первый визит до 15 декабря!</div>
